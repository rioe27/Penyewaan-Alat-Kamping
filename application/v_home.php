			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"> <a href="index.php/kons">Home</a></li>						
						<li><a href="index.php/about">About</a></li>
						<li><a href="index.php/persyaratan">Persyaratan</a></li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Alat Kamping</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Tenda</a></li>
									<li><a data-toggle="tab" href="#tab2">Jaket</a></li>
									<li><a data-toggle="tab" href="#tab3">Sepatu Tracking</a></li>
									<li><a data-toggle="tab" href="#tab4">Cooking Set</a></li>
									<li><a data-toggle="tab" href="#tab1">Alat Kamping</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<img src="assets/img/jaket.png" alt="">
												
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">Jaket Gunung</a></h3>
												<h4 class="product-price">Rp. 10000 </h4>
