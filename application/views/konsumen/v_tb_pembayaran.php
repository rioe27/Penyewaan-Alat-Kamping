...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/tabel/DataTables/datatables.min.css'?>"/>
		
		<link rel="stylesheet" type="text/css" href="<?php echo base_url().'https://cdn.datatables.net/v/dt/dt-1.10.20/b-1.6.1/fc-3.3.0/sl-1.3.1/datatables.min.css'?>"/>
	...
	<div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <p><a href="<?php echo base_url() ?>konfirmasi/add"  class='btn btn-success '> Konfirmasi Pembayaran</a></p>
                          ...
                          $no = 0;  
                           foreach($barang as $rak) { $no++?>
                            <tr>
								...
								<td><?php echo $rak['nominal_tf']; ?></td>
							
								<td><?php echo $rak['bukti_tf']; ?></td>
								<td><?php echo $rak['status']; ?></td>
		...
		<script src="<?php echo base_url().'assets/electro/js/datatable.js' ?> "></script>
		...
		<script type="<?php echo base_url().'assets/tabel/DataTables/datatables.min.js'?>"></script>
		<script type="text/javascript" src="<?php echo base_url().'https://cdn.datatables.net/v/dt/dt-1.10.20/b-1.6.1/fc-3.3.0/sl-1.3.1/datatables.min.js'?>"></script>
