                   ...
                   foreach ($sewa as $alat ) { ?>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<div class="post_content">
									<div class="post_meta">
									<?php echo $this->session->flashdata('sewa'); ?>
									<div class="col-md-6">
									Nama Alat :
									...
									<button class="btn btn-primary"> <i class="fa fa-shopping-cart"></i> Sewa</button>
									</div>
									<br>
									<br>
						</div>
                        ...
                        <div class="col-sm-4">
                            <div class="serviceBox_1">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>Lakukan konfirmasi pembayaran untuk menyelesikan pemesanan sewa anda.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="serviceBox_1">
                                ...
                                <div class="service-content">
                                    <h3>Cetak Bukti</h3>
                                    <p>Cetak bukti pemesanan anda dan selajutnya diserahkan kepada pemilik sewa,untuk mendapatkan sewa pesanan anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
