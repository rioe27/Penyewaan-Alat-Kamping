			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"><a href="index.php/v_home">Home</a></li>						
          ...
          <div class="box box-info">
            ...
            <?php echo form_open('pendaftaran/simpan_bio_kons','class="form-horizontal"');?>
              ...
              <input type="hidden" class="form-control" name="id_akun" aria-describedby="emailHelp" value="<?php foreach ($akun as $b) { ?> <?php echo $b->id_user; ?> <?php } ?>">
                ...
                <div class="form-group">
                  <label for="Nama" class="col-sm-2 control-label">No Tlpn</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="no_tlpn" placeholder="Masukkan Nama Anak anda"  value="<?php echo set_value('no_tlpn'); ?>">
