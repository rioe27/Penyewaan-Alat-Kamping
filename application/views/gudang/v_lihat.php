    ...
    <div class="col-md-10">
		<div class="row">
            ...
            <table class="table table-striped">
				<tr><th width='30%'>Kode</th><td><?php echo $kode; ?></td></tr>                                
                <tr><th width='30%'>Nama Alat</th><td><?php echo $nama_alat; ?></td></tr>                                
                <tr><th width='30%'>Kategori</th><td><?php echo $kategori; ?></td></tr>                                
                <tr><th width='30%'>Stok Alat</th><td><?php echo $stok_alat; ?></td></tr>                                
                <tr><th width='30%'>Warna</th><td><?php echo $warna; ?></td></tr>                                
                <tr><th width='30%'>Harga Sewa</th><td><?php echo $harga_sewa; ?></td></tr>                                
                <tr><th width='30%'>Deskripsi</th><td><?php echo $deskripsi; ?></td></tr>                                                             
                <tr><th width='30'>Gambar</th><td><img style="height:200px;" src="<?php echo base_url(); ?>img/<?php echo $gambar ?>"></td></tr>        				
            </table>
					</div>
						<p><a class="btn btn-success" href="<?php echo base_url();?>gudang/index">Kembali</a></p>
                    </div>
                </div>
                </form>
            </div>
