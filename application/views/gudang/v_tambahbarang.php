...
<!-- DataTables -->
	...
	<div class="panel-body">
		<form role="form" action="<?php echo base_url(); ?>gudang/insert" method="POST" enctype="multipart/form-data"> 
			...
			<div class="form-group">
				...
				<input class="form-control"  type="number" name="harga_sewa" value="Rp.">
			</div>
			...
			<div class="form-group">					
				...
				<!--<a class="btn btn-success" href="<?php //echo base_url();?>gudang">Tambah</a> -->					
				<button type="submit" class="btn btn-success">Simpan </button>						
				<a class="btn btn-success" href="<?php echo base_url();?>gudang">Kembali</a>					
			</div class="form-group">						
