...
<!-- DataTables -->
	...
	<div class="panel-body">
		<form role="form" action="<?php echo base_url(); ?>gudang/update" method="POST" enctype="multipart/form-data"> 
	        ...
	        <div class="panel-body">
									...
									<div class="form-group">
                                        <label>Kode</label>
                                        <input class="form-control" readonly name="kode" value="<?php echo $kode; ?>" />
                                    </div>
                                      <div class="form-group">
                                        <label>Nama alat</label>
                                        <input class="form-control" readonly name="nama_alat" value="<?php echo $nama_alat; ?>" />
                                      </div>
									<div class="form-group">
                                        <label>Kategori</label>
										<input class="form-control" readonly name="kategori" value="<?php echo $kategori; ?>" />
                                    </div>
                                      <div class="form-group">
                                        <label>Stok Alat</label>
                                        <input class="form-control"  name="stok_alat" value="<?php echo $stok_alat; ?>" /> 
                                      </div>
                                      <div class="form-group">
                                        <label>Harga Sewa</label>
                                        <input class="form-control"  name="harga_sewa" value="<?php echo $harga_sewa; ?>">
                                      </div>
									   <div class="form-group">
                                        <label>Warna</label>
                                        <input class="form-control" readonly  name="warna" value="<?php echo $warna; ?>">
                                      </div>
									   
									<div class="form-group">
                                        <label>Deskripsi</label>
                                        <textarea class="form-control" rows="3" readonly name="deskripsi"><?php echo $deskripsi; ?>
										</textarea>
                                    </div>
									<div class="form-group">
                                        <label>Gambar</label>
                                        <input type="file" readonly name="file_upload" value=""/><?php echo $gambar; ?>
                                    </div>
                    ...
                    <div >
						...
						<a class="btn btn-default" href="<?php echo base_url();?>gudang">Batal</a>
					</div>
            </div>            														
