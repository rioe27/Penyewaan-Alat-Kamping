    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Pengecekan Kondisi Alat</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Pengecekan Kondisi Alat</div>
        <div class="card-body">
            <div class="table-responsive">
			
            <form role="form" action="<?php echo base_url(); ?>Pengembalian_gudang/update" method="POST" enctype="multipart/form-data">
                ...
                <form action="">
                    <fieldset>
                        <div class="form-group">
                            <label>ID_sewa</label>
                            <input class="form-control" name="ID_sewa" value="<?php echo $ID_sewa; ?>" />
                        </div>
						...
						<div class="form-group">
                            ...
                            <textarea class="form-control"  name="deskripsi"><?php echo $deskripsi_kondisi_alat; ?></textarea>
                        </div>
                        ...
                        <div>
                             <i class="col-sm-offset-2 col-sm-10"></i>
								<input type="hidden" class="form-control" name="ID_pengembalian" value="<?php echo $ID_pengembalian; ?>" />
                                <button type="submit" class="btn btn-primary">Update</button>                                     
								<a class="btn btn-default" href="<?php echo base_url();?>Pengembalian_gudang/index">Batal</a>
						</div>             			
                </form>
            </div>
