    ...
    <div class="col-md-10">
		<div class="row">
            ...
            <table class="table table-striped">
				<tr><th width='30%'>Label Alat</th><td><?php echo $label_alat; ?></td></tr>                                
                <tr><th width='30%'>Nama Alat</th><td><?php echo $nama_barang; ?></td></tr>                                
                <tr><th width='30%'>Kategori</th><td><?php echo $kategori_barang; ?></td></tr>                                
                <tr><th width='30%'>Jumlah</th><td><?php echo $jumlah; ?></td></tr>                                                                
                <tr><th width='30%'>Keteranga</th><td><?php echo $keterangan; ?></td></tr>                                                             
                <tr><th width='30'>Status</th><td><?php echo $status_alat ?></td></tr>        				
            </table>
					</div>
						<p><a class="btn btn-success" href="<?php echo base_url();?>kerusakan/index">Kembali</a></p>
                    </div>
                </div>
                </form>
            </div>
