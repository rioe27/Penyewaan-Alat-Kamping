...
<!-- DataTables -->
    ...
    <div class="container-fluid">
		...
		<div class="row">
                ...
                <!-- <form role="form" action="<?php ///echo base_url(); ?>admin/tambahdata" method="POST" enctype="multipart/form-data"> -->
                        
             <div class="col-md-6">
					<div class="content-box-large">
					<div class="panel-heading">
					<!--<div class="panel-title " > <h3>Laporan pembayaran </h3></div> -->  
					<div class="table-responsive">
            <table class="table table-striped">
				<tr><th width='30%'>Nama</th><td><?php echo $nama; ?></td></tr>   
                <tr><th width='30%'>No Tlpn</th><td><?php echo $no_tlpn; ?></td></tr>                                                                        
                <tr><th width='30%'>Tanggal Transfer</th><td><?php echo $tgl_transfer; ?></td></tr>                                
                <tr><th width='30%'>Nama Bank</th><td><?php echo $bank; ?></td></tr>                                
                <tr><th width='30%'>No Rekening</th><td><?php echo $no_rekening; ?></td></tr>                         
                <tr><th width='30%'>Atas Nama</th><td><?php echo $atas_nama; ?></td></tr> 
				<tr><th width='30%'>Nominal Transfer</th><td><?php echo $nominal_tf; ?></td></tr>
				<tr><th width='30%'>Total Biaya Sewa</th><td><?php echo $biaya_sewa; ?></td></tr> 
				<tr><th width='30%'>Bukti Transfer</th><td><?php echo $bukti_tf; ?></td></tr> 	
				<tr><th width='30%'>Status Pembayaran</th><td><?php echo $status; ?></td></tr>	
            </table>
					</div>
						<p><a class="btn btn-success" href="<?php echo base_url();?>pembayaran/index">Kembali</a></p>
                    </div>
                </div>
                </form>
            </div>
