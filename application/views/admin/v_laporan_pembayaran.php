	...
	<ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo site_url('Penyewaan_pembayaran/index') ?>">Laporan Sewa Alat</a> 
	   ...
	   <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo site_url('Pengembalian_pembayaran/index') ?>">Laporan Pengembalian</a> 
...
<!-- DataTables -->
	...
	<div class="panel-body">
		<form role="form" action="<?php echo base_url(); ?>pembayaran/update" method="POST" enctype="multipart/form-data"> 
	        ...
	        <div class="panel-body">
									...
									<div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>No Tlpn</label>
                                        <input class="form-control" name="no_tlpn" value="<?php echo $no_tlpn; ?>" />
                                     </div>
									 																
                                    <div class="form-group">
                                        <label>Tanggal Transfer</label>
                                        <input class="form-control"  name="tgl_transfer" value="<?php echo $tgl_transfer; ?>" /> 
                                    </div>
									
                                    <div class="form-group">
                                        <label>Bank</label>
                                        <input class="form-control"  name="bank" value="<?php echo $bank; ?>">
                                    </div>
									   <div class="form-group">
                                        <label>No Rekening</label>
                                        <input class="form-control"   name="no_rekening" value="<?php echo $no_rekening; ?>">
                                      </div>
									   
									<div class="form-group">
                                        <label>Atas Nama</label>
                                        <input class="form-control"   name="atas_nama" value="<?php echo $atas_nama; ?>">
                                    </div>
									
									<div class="form-group">
                                        <label>Nominal Transfer</label>
                                        <input class="form-control"   name="nominal_tf" value="<?php echo $nominal_tf; ?>">
                                    </div>
									
									<div class="form-group">
                                        <label>Total Biaya Sewa</label>
                                        <input class="form-control"   name="biaya_sewa" value="<?php echo $biaya_sewa; ?>">
                                    </div>																	
                    ...
                    <div >
						...
						<a class="btn btn-default" href="<?php echo base_url();?>pembayaran">Batal</a>
					</div>
            </div>            														
