    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pengecekan Kondisi Alat</li>
        </ol>
        ...
        <div class="card-body">
            ...
            <form role="form" action="<?php echo base_url(); ?>Pengembalian_admin/update" method="POST" enctype="multipart/form-data">
                ...
                <form action="">
                    <fieldset>
						...
						<div class="form-group">
                            <label>Status</label>
                            <select class="form-control" name="status_pengembalian"value="<?php echo $status_pengembalian; ?>">
                        ...
                        <div>
                             <i class="col-sm-offset-2 col-sm-10"></i>
								<input type="hidden" class="form-control" name="ID_sewa" value="<?php echo $ID_sewa; ?>" />
                                <button type="submit" class="btn btn-primary">Simpan</button>                                     
								<a class="btn btn-default" href="<?php echo base_url();?>Pengembalian_admin/index">Batal</a>
						</div>             			
                </form>
            </div>
