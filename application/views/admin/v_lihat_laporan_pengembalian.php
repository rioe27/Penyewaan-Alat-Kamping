    ...
    <div class="container-fluid">
        ...
        <!-- Detail Laporan -->
          ...
          <div class="card-header">
            ...
            Detail Laporan Pengembalian</div>
          <div class="card-body">
		...
		<div class="row">
            ...
            <table class="table table-striped">
				<tr><th width='30%'>ID Sewa</th><td><?php echo $ID_sewa; ?></td></tr>   
                <tr><th width='30%'>Nama Konsumen</th><td><?php echo $nama; ?></td></tr>                                                                        
                ...
                <tr><th width='30%'>Catatan Kondisi Alat</th><td><?php echo $deskripsi_kondisi_alat; ?></td></tr>    
				<tr><th width='30%'>Status Pengembalian</th><td><?php echo $status_pengembalian; ?></td></tr>	
            </table>
					</div>
						<p><a class="btn btn-success" href="<?php echo base_url();?>Pengembalian_admin/index">Kembali</a></p>
                    </div>
                </div>
                </form>
            </div>
