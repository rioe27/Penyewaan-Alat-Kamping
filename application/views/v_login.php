...
<div class="login-box">
  <div class="login-logo">
    <!-- <a href="../../index2.html"><b>Les Privat Baitul Jannah</b></a> -->
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- /.social-auth-links -->
    <br>
    <a href="<?php echo base_url('index.php/daftar'); ?>" class="text-center">Belum punya akun, silahkan mendaftar di sini</a>
