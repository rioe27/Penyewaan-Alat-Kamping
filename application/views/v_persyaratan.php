	...
	<body>
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="<?php echo base_url('index.php/login'); ?>"><i class="fa fa-user-o"></i>"><i class="fa fa-user-o"></i> My Account</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="<?php echo base_url('index.php/Welcome/persyaratan'); ?>">Persyaratan</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Persyaratan</h3>
		...
		<ul class="list-group"> 
			<h4>
				  <li class="list-group-item active">JAMINAN</li>
				  <li class="list-group-item">Untuk Jaminan Sewa Peminjam meninggalkan salah satu identitas dibawah ini.</li>
				  <li class="list-group-item">1. KTP / SIM / KTM yang Jelas & Berlaku</li>
				  <li class="list-group-item">2. Kartu Pelajar + Harus sertakan Foto Kopi Kartu Keluarga</li>
				  
		</ul> 
			</h4>
			
			<ol>
				<h3> <p align="left">catatan:</li>
				  <p align="left">Bawalah Cadangan Minimal 2 Identitas.</p>
				  <p align="left">*Untuk Sewa Lebih Banyak Meninggalkan 2 Identitas.</p>
				  </h3>
			</ol> 
		</div>
